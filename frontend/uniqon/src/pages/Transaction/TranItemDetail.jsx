...
export function TranItemDetail() {
  ...
  const { sellerAddress, setSellerAddress, setSelectedPostId } = useTransactionStore();
                ...
                <Card className="mx-auto w-full max-w-[24rem]">
                  ...
                  <CardFooter className="pt-0">
                    <Button
                      ...
                      onClick={() => {
                        수정handleOpen();
                        updateSales(price, title, content);
                      }}
                      fullWidth
                    >
                      수정
